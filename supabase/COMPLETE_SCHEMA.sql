-- ==========================================================
-- OXISAN - COMPLETE DATABASE SCHEMA
-- Generated: 2026-06-09
-- Database: PostgreSQL (Supabase)
-- ==========================================================
--
-- This file contains the complete database schema for the Oxisan
-- Healthcare Logistics Operating System. It includes all tables,
-- indexes, triggers, and Row Level Security (RLS) policies.
--
-- EXECUTION ORDER:
--   1. Core Schema (organizations, facilities, members)
--   2. Asset Management (assets, categories, maintenance)
--   3. Orders & Inventory (customers, orders, inventory)
--   4. Fleet Operations (vehicles, drivers, routes)
--   5. Contracts & Billing (contracts, invoices, payments)
--   6. Workflows & Events (notifications, geofences, AI)
--   7. User Profiles & Questionnaires
--   8. Additional Roles & Permissions
--
-- ==========================================================
...
-- Invoices (Contract-driven billing)
...
-- Simple Invoice Table (for employee billing)
CREATE TABLE IF NOT EXISTS simple_invoices (
  ...
  CONSTRAINT valid_simple_payment_method CHECK (payment_method IN ('virtual', 'cash', 'check')),
  CONSTRAINT valid_simple_payment_status CHECK (payment_status IN ('pending', 'completed', 'cancelled'))
);

-- Simple Invoice Items
CREATE TABLE IF NOT EXISTS simple_invoice_items (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  invoice_id UUID NOT NULL REFERENCES simple_invoices(id) ON DELETE CASCADE,
  description TEXT NOT NULL,
  quantity INTEGER NOT NULL,
...
ALTER TABLE simple_invoice_items ENABLE ROW LEVEL SECURITY;
...
-- ==========================================================
-- RLS POLICIES - CUSTOMERS, ORDERS, INVENTORY
-- ==========================================================
...
-- ==========================================================
-- RLS POLICIES - CONTRACTS & BILLING
-- ==========================================================
...
-- ==========================================================
-- RLS POLICIES - USER PROFILES & QUESTIONNAIRES
-- ==========================================================
...
-- ==========================================================
-- RLS POLICIES - ROLES & EMPLOYEE PERMISSIONS
-- ==========================================================
...
CREATE POLICY "Owner can create simple invoices"
  ...
  WITH CHECK (
    ...
    EXISTS (
      SELECT 1 FROM organization_members
      WHERE organization_members.organization_id = simple_invoices.organization_id
      AND organization_members.user_id = auth.uid()
      AND organization_members.role = 'owner'
    )
  );

CREATE POLICY "Organization members can view simple invoices"
...
CREATE POLICY "Owner can update own simple invoices"
...
CREATE INDEX IF NOT EXISTS idx_facility_zones_facility ON facility_zones(facility_id);

-- Assets
CREATE INDEX IF NOT EXISTS idx_assets_organization ON assets(organization_id);
CREATE INDEX IF NOT EXISTS idx_assets_category ON assets(category_id);
CREATE INDEX IF NOT EXISTS idx_assets_status ON assets(status);
CREATE INDEX IF NOT EXISTS idx_assets_facility ON assets(current_facility_id);
...
CREATE INDEX IF NOT EXISTS idx_certifications_asset ON asset_certifications(asset_id);
CREATE INDEX IF NOT EXISTS idx_certifications_expiry ON asset_certifications(expiry_date);
...
CREATE INDEX IF NOT EXISTS idx_inventory_category ON inventory(asset_category_id);
CREATE INDEX IF NOT EXISTS idx_inventory_transactions_facility ON inventory_transactions(facility_id);
...
-- Workflows
CREATE INDEX IF NOT EXISTS idx_workflow_def_org ON workflow_definitions(organization_id);
CREATE INDEX IF NOT EXISTS idx_workflow_inst_org ON workflow_instances(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_ai_recs_org ON ai_recommendations(organization_id);
...
-- User Profiles & Questionnaires
CREATE INDEX IF NOT EXISTS idx_user_profiles_user_id ON user_profiles(user_id);
CREATE INDEX IF NOT EXISTS idx_client_questionnaires_organization_id ON client_questionnaires(organization_id);
...
CREATE INDEX IF NOT EXISTS idx_employee_permissions_org_id ON employee_permissions(organization_id);
