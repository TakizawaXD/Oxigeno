        ...
        <div className="space-y-8">
          <div className="space-y-4">
            <h1 className="text-4xl font-bold leading-tight">
              Healthcare Logistics<br />Operating System
            </h1>
            <p className="text-lg text-primary-100 leading-relaxed">
              Enterprise-grade platform for managing medical assets, oxygen cylinders,
              equipment, and healthcare supply chain operations with AI-powered intelligence.
            </p>
          </div>

          <div className="grid grid-cols-2 gap-4">
            {[
              { label: 'Assets Tracked', value: '10M+' },
              { label: 'Daily Deliveries', value: '50K+' },
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-secondary-50 dark:bg-secondary-950 text-secondary-500">New to HealthLogix?</span>
            </div>
          </div>
